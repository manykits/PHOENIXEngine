// PX2InputEventData.hpp

#ifndef PX2INPUTEVENTDATA_HPP
#define PX2INPUTEVENTDATA_HPP
...
namespace PX2
{
	...
	class PX2_ENGINE_ITEM TouchState
	{
	public:
		TouchState();
		~TouchState();
	...
	class PX2_ENGINE_ITEM InputEventData
	{
	public:
		InputEventData();
		~InputEventData();
	...
	class PX2_ENGINE_ITEM CanvasInputData
	{
	public:
		CanvasInputData();
		~CanvasInputData();
