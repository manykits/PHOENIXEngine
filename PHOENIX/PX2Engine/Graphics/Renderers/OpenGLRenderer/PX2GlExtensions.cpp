		...
		else if (*pcToken == '4')
		{
			...
			if (pcToken && *pcToken == '.')
			{
				...
				if (pcToken)
				{
					...
					case '1': return GT_VERSION_4_1;
					case '2': return GT_VERSION_4_2;
					case '3': return GT_VERSION_4_3;
					case '4': return GT_VERSION_4_4;
					case '5': return GT_VERSION_4_5;
					default: return GT_VERSION_4_0;
					}
				}
			}
		}
