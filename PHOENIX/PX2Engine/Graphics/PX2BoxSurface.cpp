...
PX2_IMPLEMENT_RTTI(PX2, Node, BoxSurface);
PX2_IMPLEMENT_STREAM(BoxSurface);
PX2_IMPLEMENT_FACTORY(BoxSurface);
PX2_IMPLEMENT_DEFAULT_NAMES(Node, BoxSurface);
...
//----------------------------------------------------------------------------
int BoxSurface::GetStreamingSize (Stream &stream) const
{
