...
{
	return Encode((char const*)s.c_str(), s.length());
}
//----------------------------------------------------------------------------
std::string Base64::Encode(const char *bytes_to_encode, int in_len)
{
	std::string ret;
	int i = 0;
	int j = 0;
...
//----------------------------------------------------------------------------
std::string Base64::Decode(const char *encoded_string, int length, int &outLength)
{
