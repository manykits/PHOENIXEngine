...
#define TOLUA_ITEM __declspec(dllexport)
#elif defined(PX2_ENGINE_DLL_IMPORT) 
#define TOLUA_ITEM __declspec(dllimport)
#else
#define TOLUA_ITEM extern
#endif
...
TOLUA_ITEM void tolua_class (lua_State* L, const char* name, const char* base);
...
TOLUA_ITEM void tolua_pushvalue (lua_State* L, int lo);
TOLUA_ITEM void tolua_pushboolean (lua_State* L, int value);
TOLUA_ITEM void tolua_pushnumber (lua_State* L, lua_Number value);
TOLUA_ITEM void tolua_pushstring (lua_State* L, const char* value);
TOLUA_ITEM void tolua_pushuserdata (lua_State* L, void* value);
TOLUA_ITEM void tolua_pushusertype (lua_State* L, void* value, const char* type);
TOLUA_ITEM void tolua_pushusertype_and_takeownership(lua_State* L, void* value, const char* type);
TOLUA_ITEM void tolua_pushfieldvalue (lua_State* L, int lo, int index, int v);
TOLUA_ITEM void tolua_pushfieldboolean (lua_State* L, int lo, int index, int v);
TOLUA_ITEM void tolua_pushfieldnumber (lua_State* L, int lo, int index, lua_Number v);
TOLUA_ITEM void tolua_pushfieldstring (lua_State* L, int lo, int index, const char* v);
TOLUA_ITEM void tolua_pushfielduserdata (lua_State* L, int lo, int index, void* v);
TOLUA_ITEM void tolua_pushfieldusertype (lua_State* L, int lo, int index, void* v, const char* type);
TOLUA_ITEM void tolua_pushfieldusertype_and_takeownership (lua_State* L, int lo, int index, void* v, const char* type);

TOLUA_ITEM lua_Number tolua_tonumber (lua_State* L, int narg, lua_Number def);
TOLUA_ITEM const char* tolua_tostring (lua_State* L, int narg, const char* def);
TOLUA_ITEM void* tolua_touserdata (lua_State* L, int narg, void* def);
TOLUA_ITEM void* tolua_tousertype (lua_State* L, int narg, void* def);
TOLUA_ITEM int tolua_tovalue (lua_State* L, int narg, int def);
TOLUA_ITEM int tolua_toboolean (lua_State* L, int narg, int def);
TOLUA_ITEM lua_Number tolua_tofieldnumber (lua_State* L, int lo, int index, lua_Number def);
TOLUA_ITEM const char* tolua_tofieldstring (lua_State* L, int lo, int index, const char* def);
TOLUA_ITEM void* tolua_tofielduserdata (lua_State* L, int lo, int index, void* def);
TOLUA_ITEM void* tolua_tofieldusertype (lua_State* L, int lo, int index, void* def);
TOLUA_ITEM int tolua_tofieldvalue (lua_State* L, int lo, int index, int def);
TOLUA_ITEM int tolua_getfieldboolean (lua_State* L, int lo, int index, int def);
