...
//----------------------------------------------------------------------------
HMatrix PX2::operator* (float scalar, const HMatrix& mat)
{
	return mat*scalar;
}
//----------------------------------------------------------------------------
...
//----------------------------------------------------------------------------
HMatrix &HMatrix::MakeDiagonal (float m00, float m11, float m22)
{
	mEntry[ 0] = m00;
	mEntry[ 1] = 0.0f;
	mEntry[ 2] = 0.0f;
...
//----------------------------------------------------------------------------
HMatrix &HMatrix::MakeRotation (const AVector& axis, float angle)
{
	float cs = cosf(angle);
	float sn = sinf(angle);
...
//----------------------------------------------------------------------------
HPoint PX2::operator* (const HPoint& p, const HMatrix& mat)
{
	return HPoint(
