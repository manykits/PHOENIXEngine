...
/* 创建一个节点，其父节点为 n  */
/*
const OrientedPoint& p,  创建这个节点时，机器人的位姿信息
double w,                这个节点的权重
TNode* n,                这个节点的父节点
unsigned int c           这个节点的孩子数目
*/
...
{
  /* weightsAlreadyNormalized 缺省值为 false  */
...
/* 对树重置，这里是反向树操作, 重置所有节点的 weight 和 counter */
