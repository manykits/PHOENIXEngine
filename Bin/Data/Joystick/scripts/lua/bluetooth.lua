...
function rc_BluetoothSerial()
    ...
    btnLeft:GetPicBoxAtState(UIButtonBase.BS_NORMAL):SetTexture("Data/Joystick/images/btnblue.png")
	...
	btnRight:GetPicBoxAtState(UIButtonBase.BS_NORMAL):SetTexture("Data/Joystick/images/btnblue.png")
